document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '' && (type === 'email' || name.toLowerCase().includes('email'))) {
  ...
  const animatableElements = document.querySelectorAll(OBSERVED_SELECTOR);
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "DAX uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7d8419c2-a657-4547-b3d0-705d12ea3bbd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7d8419c2-a657-4547-b3d0-705d12ea3bbd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7d8419c2-a657-4547-b3d0-705d12ea3bbd';
